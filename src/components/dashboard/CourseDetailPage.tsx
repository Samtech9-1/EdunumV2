      ...
      <div className="h-full bg-gray-50">
        <div className="grid lg:grid-cols-3 gap-0 h-full">
          ...
          <div className="lg:col-span-2 bg-black flex flex-col">
            ...
            {selectedVideo && (
              <motion.div 
                className="bg-white p-4 lg:p-6 border-t border-gray-200"
                                ...
                                {chapitre.sections?.map((section, sectionIndex) => {
                                  ...
                                  return (
                                    <li key={section.idSection} className="video-item-wrapper">
                                      <motion.div
                                        className={`video-item flex items-center space-x-3 p-3 lg:p-4 text-left hover:bg-gray-50 transition-colors border-b border-gray-200 last:border-b-0 cursor-pointer ${
