                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-4 lg:gap-6 text-sm text-gray-600">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-500">Contenu protégé</span>
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              <div className="p-4 lg:p-6 border-b border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-base lg:text-lg font-bold text-gray-900 flex items-center">
                    <BookOpen className="h-4 w-4 lg:h-5 lg:w-5 mr-2 text-blue-500" />
                    Contenu du cours
                  </h2>
                </div>
                    ...
                    {course?.chapitres && course.chapitres.length > 0 ? (
                      course.chapitres.map((chapitre, chapitreIndex) => (
                        <div key={chapitreIndex} className="accordion-item border border-gray-200 rounded-lg overflow-hidden">
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <div className="w-6 h-6 lg:w-8 lg:h-8 bg-blue-50 rounded-full flex items-center justify-center border border-blue-200">
                                <span className="text-blue-500 text-xs lg:text-sm font-bold">{chapitreIndex + 1}</span>
                              </div>
                              <div>
                                  ...
                                  {chapitre.sections?.map((section, sectionIndex) => {
                                    ...
                                    return (
                                      <li key={section.idSection}>
                                        <motion.div
                                          className={`flex items-center space-x-3 p-3 lg:p-4 text-left hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-b-0 cursor-pointer ${
                                            isItemSelected ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''
                                          }`}
                                        ...
                                        >
                                          <div className="w-5 h-5 lg:w-6 lg:h-6 bg-gray-200 rounded-full flex items-center justify-center flex-shrink-0">
                                            {isItemSelected ? (
                                              <PauseCircle className="h-3 w-3 lg:h-4 lg:w-4 text-blue-500" />
                                            ) : (
                                          ...
                                          <div className="flex-1 min-w-0">
                                            <span className={`text-xs lg:text-sm font-medium truncate block ${
                                              isItemSelected ? 'text-blue-500' : 'text-gray-900'
                                            }`}>
                                              {section.title}
                                            </span>
